...
const AddFilterComponent = ({ filters, setFilters }) => {
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-y-2 rounded-[14px] border border-lightGrey p-2">
        {filters.length === 0 && <span>No filters have been added yet.</span>}
        {filters.map((filter, i) => (
          <div
            key={i}
            className="flex w-full rounded-md border border-white bg-lightGrey p-4 text-sepiaGray"
          >
